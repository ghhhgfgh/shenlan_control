...
void LQRControllerNode::odomCallback(const nav_msgs::Odometry::ConstPtr& msg) {
  ...
  vehicleState_.angular_velocity =  msg->twist.twist.angular.z;// 转角速度
  //std::cout<<"angular x "<<msg->twist.twist.angular.x<<std::endl;
  //std::cout<<"angular y "<<msg->twist.twist.angular.y<<std::endl;
  //std::cout<<"angular z "<<msg->twist.twist.angular.z<<std::endl;
...
bool LQRControllerNode::loadRoadmap(const std::string& roadmap_path,
  ...
  for (size_t i = 0; i < headings.size(); i++) {
    ...
    cout<<"x: "<< trajectory_pt.x<<" , ";
    cout<<"y: "<< trajectory_pt.y<<" , ";
    cout<<"heading: "<< trajectory_pt.heading <<" , ";
    cout<<"kappa: "<< trajectory_pt.kappa<<std::endl;
